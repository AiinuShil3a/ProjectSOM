      ...
      <div class="col-lg-8">
        ...
        <article>
          ...
          <header class="mb-4">
            ...
            <?php echo $rs2['cs_ApplicationDates']?>
          </div>
          ...
          <section class="mb-5 course-body">
            ...
            <p class="fs-6 mb-4 course-content"><?php echo $rs2['cs_ApplicationDates']?></p>
            ...
            <p class="fs-6 mb-4 course-content"><?php echo $rs2['cs_During']?></p>
            ...
            <ul class="list-inline course-content fs-6">
              ...
              <li class="list-inline-item"><?php echo $rs2['cs_Place']?></li>
            </ul>
            ...
            <ul class="course-content fs-6">
              <li>เพื่อพัฒนา TPACK สำหรับครูวิทยาศาสตร์</li>
              <li>เพื่อส่งเสริมการจัดการเรียนรู้โดยใช้แอพพลิเคชั่นให้กับครูวิทยาศาสตร์</li>
            </ul>

            <h5 class="fw-bolder mb-4 mt-5" id="list-item-4"><i class="far fa-user"></i> กลุ่มเป้าหมาย</h5>
            <ul class="list-inline course-content fs-6">

              <li class="list-inline-item">ครูวิทยาศาสตร์ตามตามบันทึกข้อตกลงความร่วมมือทางวิชาการ จำนวน 30 คน/รุ่น</li>
              <li class="list-inline-item">เป็นการส่งเสริมการจัดการเรียนรู้โดยใช้แอพพลิเคชั่นให้กับครูวิทยาศาสตร์</li>
            ...
            <ul class="course-content fs-6">
              <li>ความรู้เกี่ยวกับ TPACK สำหรับครูวิทยาศาสตร์</li>
              <li>การใช้ TPACK ในการสร้างความรู้ด้วยตนเองของนักเรียน</li>
              <li>การประเมิน TPACK ของครูวิทยาศาสตร์</li>
              <li>การใช้แอพพลิเคชั่นในการจัดการเรียนรู้วิทยาศาสตร์์</li>
            </ul>

            <h5 class="fw-bolder mb-4 mt-5" id="list-item-7"><i class="fas fa-file-alt"></i> การวัดผลประเมินผล</h5>
            <h6>สิ่งที่ต้องประเมิน</h6>
            <ul class="course-content fs-6">
              <li>คะแนนการประเมินตนเองและประเมินแผนการจัดการเรียนรู้อยู่ในระดับค่อนข้างเชื่อมั่นขึ้นไป
                และมีคะแนนประเมินแผนอยู่ในระดับมาก</li>
            </ul>
            <h6>วิธีการประเมิน</h6>
            <ul class="course-content fs-6">
              <li>แบบประเมินตนเอง</li>
              <li>แบบประเมินแผนการจัดการเรียนรู้</li>
            </ul>

            <h5 class="fw-bolder mb-4 mt-5" id="list-item-8"><i class="fas fa-award"></i> ผลที่คาดว่าจะได้รับ</h5>
            <ul class="course-content fs-6">
              <li>ครูมีความสามารถด้าน TPACK ในการจัดการเรียนรู้วิทยาศาสตร์เพิ่มมากขึ้น</li>
              <li>ครูวิทยาศาสตร์สามารถออกแบบแผนการจัดการเรียนรู้ในการบูรณาการ TPACK ได้</li>
            ...
            <ul class=" course-content fs-6 contact-course">
              <li><a href="<?=$rs2['cs_Plan'];?>" target="_blank" class="orange-theme-2">ดาวน์โหลด PDF</a> </li>
            </ul>
            ...
            <ul class="list-inline course-content fs-6 contact-course">
              <li class="list-inline-item"><i class="fas fa-phone-square-alt"></i> <a href="#"><?php echo $rs2['cs_Information']?></a>
              </li>
            </ul>
      ...
      <div class="col-lg-4  d-none d-lg-block">
        ...
        <div id="list-example " class="list-group sticky-top ">
          ...
          <div class="my-3 card-rela">
            <a href="https://forms.gle/SC6zWtHG8bFuE2Vx5" target="_blank" class="btn bg-or-conts ">ลงทะเบียน</a>
            <a href="#list-item-10" class="btn bg-or-5 text-light">สอบถามเพิ่มเติม</a>
